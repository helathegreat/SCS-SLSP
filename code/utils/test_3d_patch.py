...
def var_all_case_LA(model, num_classes, patch_size=(112, 112, 80), stride_xy=18, stride_z=4):
    ...
    with open('D:/SSL/SS-Net/data/LA/test.list', 'r') as f:
        image_list = f.readlines()
    image_list = ["D:/SSL/SS-Net/data/LA/2018_Atrial_Segmentation_Challenge_COMPLETE_DATASET/Training_Set/" + item.replace('\n', '') + "/mri_norm2.h5" for item in image_list]
